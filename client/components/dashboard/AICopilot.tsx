...
export default function AICopilot() {
    ...
    return (
      <div className="fixed bottom-4 right-4 z-50">
        <Button
          ...
          className="h-12 w-12 rounded-full bg-dashboard-accent hover:bg-dashboard-accent-light shadow-lg"
        >
  ...
  return (
    <div
      className={`fixed ${isExpanded ? "inset-4" : "bottom-4 right-4"} z-50 transition-all duration-300`}
    >
      <div
        className={`bg-dashboard-background border border-dashboard-border rounded-lg shadow-2xl ${
          isExpanded ? "w-full h-full" : "w-80 h-96"
        } flex flex-col`}
      >
        {/* Header */}
        <div className="p-4 border-b border-dashboard-border">
          ...
          {/* Tabs */}
          <div className="flex gap-1 mt-3 bg-dashboard-surface rounded-lg p-1">
            <Button
